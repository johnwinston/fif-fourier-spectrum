...
def complexFIF(x, it):
   ...
   for i in range(int(nMaps)):
      sum += (d[i]*(complexFIF((x - e[i]) / float(a[i]), it-1))
         + c[i]*((x - e[i]) / float(a[i])) + f[i]) * uFunc(x,i)
...
for i in range(rangeI):
   ...
   hz += 1/1000
   FIFPoints.append(hz)
   FIFPoints.append(complexFIF(hz, globalIt))
   print("FIF Percent Complete:", sum * 100)
...
for i in range(rangeI):
   ...
   print("qOmega Percent Complete:", sum * 100)
...
for i in range(rangeI):
   ...
   print("gOmega Percent Complete:", sum * 100)
'''
sum = 0
hz = 0
for i in range(rangeI):
   ...
   print("integration Percent Complete:", sum * 100)
'''
sum = 0
hz = 0
for i in range(rangeI):
   ...
   integrationPointsFull.append(iterative(hz,10))
   print("Iterative Percent Complete:", sum * 100)
